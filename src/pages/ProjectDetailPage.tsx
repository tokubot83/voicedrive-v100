...
export const ProjectDetailPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between mb-2">
                <span className="text-sm text-gray-600">合意レベル</span>
                <span className="font-semibold">{project.consensusLevel}%</span>
              </div>
      ...
      <Card>
        <div className="p-6">
          <h2 className="text-lg font-semibold mb-4">承認プロセス</h2>
