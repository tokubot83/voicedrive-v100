...
const UserGuide: React.FC = () => {
  ...
  const faqData = [
    ...
    },
    {
      id: 7,
      question: '提案に投票するには？',
      answer: 'アイデアボイスハブの「議題進捗」から、投票したい提案を選び、賛成/反対ボタンをクリックしてください。投票期限が表示されているので、期限内に投票することをお勧めします。',
      category: 'ideavoice',
      keywords: ['投票', '賛成', '反対', '議題']
    },
    {
      id: 19,
      question: '投票期限が過ぎたらどうなりますか？',
      answer: '投票期限が過ぎると、投票は締め切られ、責任者（主任・師長・部長など）が投票結果を見て判断を行います。期限内にできるだけ多くの方に投票していただくことで、より良い判断ができます。',
      category: 'ideavoice',
      keywords: ['投票期限', '締め切り', '期限切れ', '投票']
    },
    {
      id: 8,
    ...
    },
    {
      id: 14,
      question: '投票期限とは何ですか？',
      answer: '投票期限とは、職員が提案に投票できる期間の締め切りです。期限内に十分な投票を集めて、みんなの意見を公平に反映させるための仕組みです。期限が近づくと通知でお知らせします。',
      category: 'proposal_management',
      keywords: ['投票期限', '締め切り', '期限', '投票', '通知']
    },
    {
      id: 15,
      question: 'なぜ投票期限内は却下できないのですか？',
      answer: 'これは公平性を確保するための重要な仕組みです。もし期限内に管理職が却下できると、職員の投票機会が奪われてしまいます。期限内は職員の投票を優先し、期限後に投票結果を見て管理職が判断します。レベルアップの承認は期限内でも可能です。',
      category: 'proposal_management',
      keywords: ['却下', '投票期限', '公平性', '制約', '管理職', '権限']
    },
    {
      id: 16,
      question: '投票期限が終了したらどうなりますか？',
      answer: '期限終了後、責任者（主任・師長・部長など）が投票結果を確認して判断を行います。承認してレベルアップ、却下、保留、または部署で対応できることに変更、のいずれかを選択できます。画面に「次にすべきこと」が表示されるので安心です。',
      category: 'proposal_management',
      keywords: ['期限終了', '投票期限', '判断', '責任者', '次のアクション']
    },
    {
      id: 17,
      question: '投稿ストーリー（タイムライン）とは何ですか？',
      answer: '投稿の「物語」を時系列で表示する機能です。投稿の作成→仲間の支持（投票）→レベルアップ→コメント→期限などが一目で分かります。「この提案がどう育ってきたか」を確認できるので、判断の参考になります。',
      category: 'proposal_management',
      keywords: ['タイムライン', 'ストーリー', '時系列', '履歴', '経緯']
    },
    {
      id: 18,
      question: '各レベルの投票期限はどれくらいですか？',
      answer: '検討中（PENDING）：14日間、部署検討（DEPT_REVIEW）：14日間、部署議題（DEPT_AGENDA）：30日間、施設議題（FACILITY_AGENDA）：60日間、法人検討（CORP_REVIEW）：90日間、法人議題（CORP_AGENDA）：90日間です。レベルが上がるほど期限も長くなり、より多くの人が投票できます。',
      category: 'proposal_management',
      keywords: ['投票期限', '期間', 'レベル', '日数', '検討期間']
    }
  ];
