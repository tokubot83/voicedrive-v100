          ...
          {activeTab === 'examples' && (
            <>
              ...
              {[
                {
                  category: '💡 アイデア共有',
                  title: '新人研修で使えるチェックリスト作成',
                  content: '新人さんが入った時に、先輩方が作成したチェックリストがあると教育がスムーズになると思います。「初日にすること」「1週間で覚えること」「1ヶ月で身につけること」みたいに段階的に整理できないでしょうか。',
                  author: '看護師（匿名）',
                  likes: 42,
                  comments: 15
                },
                {
                  category: '💬 雑談',
                  title: '今日のほっこりエピソード',
                  content: '患者様から「いつもありがとう」って手紙をもらいました。疲れが吹き飛びました✨ みなさんも最近のほっこりエピソードがあったら教えてください！',
                  author: '介護職員',
                  likes: 38,
                  comments: 12
                },
                {
                  category: '🎉 イベント企画',
                  title: 'お花見お弁当企画はいかがでしょう？',
                  content: '来月の休日に、近くの公園でお花見しませんか？希望者で手作りお弁当を持ち寄って、リフレッシュできたらいいなと思います。参加希望の方、コメントください！',
                  author: '事務職員',
                  likes: 56,
                  comments: 23
                },
                {
                  category: '💡 アイデア共有',
                  title: '感謝の気持ちを伝える工夫',
                  content: '他部署の方にお世話になった時、口頭だけでなく簡単なメモを残すようにしています。「ありがとうございました」の一言でも、後で見返すと嬉しいものです。みなさんの感謝の伝え方も教えてください。',
                  author: 'リハビリ職員',
                  likes: 45,
                  comments: 18
                },
                {
                  category: '💬 雑談',
                  title: 'おすすめのリフレッシュ方法',
                  content: '夜勤明けの疲れを取るのに、最近ホットアイマスクにハマっています。10分で癒されます！みなさんのおすすめリフレッシュ方法があったら教えてください。',
                  author: '医師',
                  likes: 67,
                  comments: 25
                }
                ...
                <div key={index} className={`bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-teal-500/30 animate-section transition-all duration-1000 ${
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                      example.category === '💡 アイデア共有' ? 'bg-blue-900/50 text-blue-300' :
                      example.category === '💬 雑談' ? 'bg-green-900/50 text-green-300' :
                      example.category === '🎉 イベント企画' ? 'bg-purple-900/50 text-purple-300' :
