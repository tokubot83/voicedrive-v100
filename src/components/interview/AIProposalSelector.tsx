...
import { Clock, MapPin, User, Star, Edit, Phone, AlertTriangle, CheckCircle } from 'lucide-react';
import { AIProposal, ProposalResponse } from '../../types/medicalSystemIntegration';

interface AIProposalSelectorProps {
  proposals: ProposalResponse;
  onSelectProposal: (proposalId: string, feedback?: string) => void;
  onRequestAdjustment: () => void;
  onTimeout?: () => void;
}

const AIProposalSelector: React.FC<AIProposalSelectorProps> = ({
  proposals,
  onSelectProposal,
  onRequestAdjustment,
  onTimeout
  ...
  // 提案カードレンダリング
  const renderProposalCard = (proposal: AIProposal) => {
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  {proposal.schedule.format === 'face_to_face' ? '対面' : 'オンライン'}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-500">
              お急ぎの場合: <a href="tel:1234" className="text-blue-600">内線1234</a>
            </p>
          </div>
        </div>
      </div>
        ...
        {selectedProposal && (
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                onClick={() => onSelectProposal(selectedProposal, feedback)}
...
export default AIProposalSelector;