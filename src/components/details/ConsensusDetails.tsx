      ...
      <div className="bg-gray-800/50 rounded-lg p-4">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-400">😍 強く賛成</span>
          ...
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-400">😊 賛成</span>
            <div className="flex items-center gap-2">
              <div className="w-24 bg-gray-700 rounded-full h-2">
          ...
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-400">😕 反対</span>
            <div className="flex items-center gap-2">
              <div className="w-24 bg-gray-700 rounded-full h-2">
          ...
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-400">😠 強く反対</span>
            <div className="flex items-center gap-2">
              <div className="w-24 bg-gray-700 rounded-full h-2">
      ...
      <div className="bg-gray-800/50 rounded-lg p-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="text-center">
            ...
            <div className="text-xs text-gray-400">看護部</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-green-400">72%</div>
            <div className="text-xs text-gray-400">リハビリ科</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-yellow-400">68%</div>
            <div className="text-xs text-gray-400">事務部</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-400">91%</div>
            <div className="text-xs text-gray-400">経営企画</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-800/50 rounded-lg p-4">
        ...
        <div className="flex items-end justify-between h-20">
          <div className="flex flex-col items-center gap-1">
            <div className="w-8 bg-blue-500/30 rounded-t" style={{ height: '40px' }} />
            <span className="text-xs text-gray-500">1日目</span>
          </div>
          <div className="flex flex-col items-center gap-1">
            <div className="w-8 bg-blue-500/50 rounded-t" style={{ height: '55px' }} />
            <span className="text-xs text-gray-500">2日目</span>
          </div>
          <div className="flex flex-col items-center gap-1">
            <div className="w-8 bg-blue-500/70 rounded-t" style={{ height: '65px' }} />
            <span className="text-xs text-gray-500">3日目</span>
          </div>
          <div className="flex flex-col items-center gap-1">
            <div className="w-8 bg-blue-500 rounded-t" style={{ height: '75px' }} />
