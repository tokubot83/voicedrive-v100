...
| プロジェクトレベル | スコア範囲 | 承認者レベル | 説明 |
|------------------|-----------|------------|------|
| PENDING | 0-99点 | 3.5+ | アイデア検討中 |
| TEAM | 100-199点 | 5+ | チームプロジェクト（5-15名） |
| DEPARTMENT | 200-399点 | 8+ | 部署プロジェクト（15-30名） |
| FACILITY | 400-799点 | 10+ | 施設プロジェクト（30-60名） |
| ORGANIZATION | 800点以上 | 13+ | 法人プロジェクト（60名以上） |
| STRATEGIC | 戦略指定 | 18 | 戦略プロジェクト（理事長承認） |
